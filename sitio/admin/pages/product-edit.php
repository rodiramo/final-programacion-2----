    ...
    <form action="actions/product-edit.php?id=<?= $product->getProductId();?>" method="post"
        ...
        <div class="form-fila">
            ...
            <input type="text" id="name" name="name" class="form-control"
                <?= isset($errors['name']) ? 'error-name' : null; ?>
        ...
        <div class="form-fila">
            ...
            <?= isset($errors['category']) ? 'error-category' : null; ?>
        ...
        <div class="form-fila">
            ...
            <input type="text" id="type" name="type" class="form-control"
               <?= isset($errors['type']) ? 'error-type' : null; ?>
        ...
        <div class="form-fila">
            ...
            <input type="text" id="price" name="price" class="form-control"
               <?= isset($errors['price']) ? 'error-price' : null; ?>  value="<?= $dataForm['price'] ?? $product->getPrice();?>">
            <?php 
        ...
        <div class="form-fila">
            <label for="img_desc">Image Description (optional)</label>
